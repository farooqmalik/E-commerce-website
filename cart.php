                ...
                <div class="col-md-12">
                    ...
                    <table class="cart-table table table-bordered">
                        ...
                        <tbody>
                           ...
                           $catres=mysqli_query($connection,$cartsql);
                           $cartr=mysqli_fetch_assoc($catres) ;
                                ...
                                <td colspan="6" class="actions">
                                    <div class="col-md-6">
                                        <!-- <div class="coupon">
                                            ...
                                            <input placeholder="Coupon code" type="text"> <button
                        ...
                        <div class="col-md-6 push-md-6 no-padding">
                            ...
                            <table class="table table-bordered col-md-6">
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Order Total</th>
                                        <td><strong><span class="amount">PKR <?php echo $total; ?>.00/-</span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
