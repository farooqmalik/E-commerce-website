                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="gal-wrap">
                                <div id="gal-slider" class="flexslider">
                                    <ul class="slides">
                                        <li><img src="admin/<?php echo $prodr['thumb']; ?>" class="img-responsive"
                                                alt="" />
                                        </li>
                                ...
                                <ul class="gal-nav">
                                    <li>
                                        <div>
                                            <img src="admin/<?php echo $prodr['thumb']; ?>" class="img-responsive"
                                                alt="" />
                                        </div>
                                    </li>
                        ...
                        <div class="col-md-7 product-single">
                            ...
                            <div class="shop-btn-wrap">
                                <input type="submit" class="button btn-small" value="Add to Cart"> </div>

                            </form>
                            <a href="addtowishlist.php?id=<?php echo $prodr['id']; ?>">Add to
                                WishList</a>
                    ...
                    <div class="tab-style3">
                        ...
                        <div style="height: auto;" class="tab-content tpl-minimal-tabs-cont align-center section-text">
                            ...
                            <div style="" class="tab-pane fade" id="mini-three">
                                ...
                                $revcoutnr=mysqli_fetch_assoc($revcountres);
                                ?>
                                    <h4 class="uppercase space35"><?php echo $revcoutnr['count']; ?> Reviews for
                                        <?php echo substr( $prodr['name'], 0, 20) ?></h4>
                                    <ul class="comment-list">
                                       ...
                                       while($selrevr = mysqli_fetch_assoc($selrevres)){
                                        ...
                                        ?>
                                        <li>
                                            <a class="pull-left" href="#"><img src="images/avatar2.png" alt="Avatar"
                                                    class="avatar" height="50" width="50"></a>
                                            <div class="comment-meta">
                                                <a
                                                    href="#"><?php echo $selrevr['firstname']." ". $selrevr['lastname']; ?></a>
                                                <span>
                                    ...
                                    <?php
                                    if(isset($_SESSION['customerid']) && !empty($_SESSION['customerid'])) {
                                    $chkrevsql="SELECT COUNT(*) AS reviewcount FROM reviews r WHERE r.uid=$uid AND r.pid=$id";
                                    $chkrevres=mysqli_query($connection, $chkrevsql);
                                    $chkrevr=mysqli_fetch_assoc($chkrevres);
                                    if ($chkrevr['reviewcount']>=1) {
                                     echo " <h4 class='uppercase space20'>You have already Reviewd This Product...</h4>";
                                    }else {
                                        # code...
                                    ...
                                    <form id="form" class="review-form" method="POST">
                                        <?php
                                        $usersql="SELECT u.email, u1.firstname, u1.lastname FROM users u JOIN usersmeta
                                        u1 WHERE u.id=u1.uid AND u.id=$uid";
                                        ...
                                        <?php }}else {
                                            echo " <h4 class='uppercase space20'>Please Login to Review This Product...</h4>";
                                        }?>
                                </div>
                                <div class="clearfix space30"></div>
                            </div>
                                ...
                                <div class="sm-item isotope-item">
                                    <div class="product">
                                        <div class="product-thumb">
                                            <img src="admin/<?php echo $relr['thumb']; ?>" class="img-responsive"
                                                alt="">
                                            <div class="product-overlay">
                                                <span>
                                                    <a href="single.php?id= <?php echo $relr['id']; ?>"
                                                        class="fa fa-link"></a>
                                        ...
                                        <div class="product-price">PKR
                                            <?php echo $relr['price']; ?>.00/-<span></span></div>
                                    </div>
                                </div>
                                <?php };?>
