    ...
    <div id="wrapper" class="wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-xs-5 col-md-offset-4 logo">
                        <a href="http://[::1]/cishop/admin"><img
                                src="https://cdn5.f-cdn.com/contestentries/1341264/29343717/5b14331def0a4_thumb900.jpg"
                        ...
                        <div class="col-md-12">
                            <div class="row shop-login">
                                <div class="col-md-6 col-md-offset-3">
                                    <?php if (isset($fmsg)) {
                                    echo "<script type='text/javascript'>swal('Error!', 'Invalid Login Credentials.', 'error')</script>";  }
                                    ?>
        ...
        <footer id="footer2">
            ...
            <div class="footer-bottom container">
                <div class="row">
                    <div class="col-md-6">
                        <p>&copy; Copyright 2019. Farooq</p>
                    </div>
                    <div class="col-md-6">
