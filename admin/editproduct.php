    ...
    if (isset($_FILES)& !empty($_FILES)) {
        ...
        if (isset($name)& !empty($name)) {
            if (($extension=='jpg'|| $extension=='jpeg')& $type=='image/jpeg'& $size<=$max_size) {
                ...
                $fmsg= "Only JPG files are allowed and should be less then 1MB.";
            }
        }else {
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="productname" id="Productname"
                        placeholder="Product Name" value="<?php echo $r['name'];?>" required>
                </div>
                <div class="form-group">
                    <label for="productdescription">Product Description</label>
                    <textarea class="form-control" name="productdescription"
                        rows="3"><?php echo $r['description'];?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="productprice" id="productprice"
                        placeholder="Product Price" value="<?php echo $r['price']; ?>" required>
                </div>
                <div class="form-group">
                ...
                if (isset($r['thumb'])& !empty($r['thumb'])) {?>
                    <br>
                    <img src="<?php echo $r['thumb'] ?>" height="100px" width="100px" alt="prodcut image">
