        ...
        <div class="s-cart">
            ...
            <div class="cart-info">
                ...
                <?php
                           ...
                           $navcatres=mysqli_query($connection,$navcartsql);
                           $navcartr=mysqli_fetch_assoc($navcatres) ;
                ...
                <div class="ci-item">
                    ...
                    <div class="ci-item-info">
                        <h5><a
                                href="single.php?id=<?php echo $navcartr['id'];?>"><?php echo substr( $navcartr['name'],0,20);?></a>
                        </h5>
